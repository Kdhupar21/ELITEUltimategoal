 ...
 */
@TeleOp
public class customPipeline extends LinearOpMode
{
    OpenCvInternalCamera2 phoneCam;
    customPipeline.RingContourAnylsis pipeline;
    int rectX = 0;
    int rect1y=0;
    ...
    public void runOpMode()
    {
        ...
        phoneCam.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener()
        {
            ...
            public void onOpened()
            {
                ...
                pipeline = new customPipeline.RingContourAnylsis();
    ...
    static class RingContourAnylsis extends OpenCvPipeline
    {
        /*
        ...
        {
            org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.StoneOrientation orientation;
            double angle;
        }
        ...
        ArrayList<org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.AnalyzedStone> internalStoneList = new ArrayList<>();
        volatile ArrayList<org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.AnalyzedStone> clientStoneList = new ArrayList<>();
        ...
        org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.Stage[] stages = org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.Stage.values();
        ...
        public ArrayList<org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.AnalyzedStone> getDetectedStones()
        {
        ...
        void analyzeContour(MatOfPoint contour, Mat input)
        {
            ...
            drawRotatedRect1(minEllipse,input);
...
//            org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.ContourRegionAnalysis aboveMidlineMetrics = analyzeContourRegion(aboveMidline);
//            org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.ContourRegionAnalysis belowMidlineMetrics = analyzeContourRegion(belowMidline);
//
...
//
//                org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.AnalyzedStone analyzedStone = new org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.AnalyzedStone();
//                analyzedStone.angle = angle;
//                analyzedStone.orientation = org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.StoneOrientation.NOT_UPRIGHT;
...
//                analyzedStone.orientation = org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.StoneOrientation.UPRIGHT;
//                internalStoneList.add(analyzedStone);
//            }
        }
        ...
        static org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.ContourRegionAnalysis analyzeContourRegion(ArrayList<Point> contourPoints)
        {
            ...
            if(hullMatOfInt.toArray().length > 0)
            {
                ...
                org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.ContourRegionAnalysis analysis = new org.openftc.easyopencv.examples.StoneOrientationExample.StoneOrientationAnalysisPipeline.ContourRegionAnalysis();
        ...
        static void drawRotatedRect1(RotatedRect rect, Mat drawOn)
        {
            /*
             * Draws a rotated rect by drawing each of the 4 lines individually
             */
            ...
            rect.points(points);
                ...
                //Imgproc.line(drawOn, points[i], points[(i+1)%4], RED, 2);
                Imgproc.ellipse(drawOn, rect, RED, 2);
